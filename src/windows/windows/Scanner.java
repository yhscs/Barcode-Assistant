...
public class Scanner extends JFrame{	
	...
	private String normalSubtext = "<html><center>Please use the barcode scanner or keyboard and your Student ID to sign in and out of this room.</center></html>";
	...
	public Scanner(String roomName, String hash) {
        ...
        this.normalTitle = "<html><center>" + this.roomName + "</center></html>";
